...
image::https://api.bintray.com/packages/ibrahimali/HtmlParser/htmlparser/images/download.svg?version=1.0.6[link="https://bintray.com/ibrahimali/HtmlParser/htmlparser/1.0.6/link"]
